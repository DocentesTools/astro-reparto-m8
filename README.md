...
| `@mano8/astro-auth-m8` (peer) | **`^2.6.0`** — the release tracking the `fa-auth-m8` `2.2.1` issuer; `2.4.0` is where the shared role hierarchy this package re-exports first appeared |
