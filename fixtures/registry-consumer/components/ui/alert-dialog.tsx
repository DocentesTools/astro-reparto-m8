...
export function AlertDialogAction({ asChild: _asChild, variant: _variant, size: _size, ...props }: AlertDialogButtonProps) {
  return <button type="button" {...props} />;
}

export function AlertDialogCancel({ asChild: _asChild, variant: _variant, size: _size, ...props }: AlertDialogButtonProps) {
  return <button type="button" {...props} />;
}
